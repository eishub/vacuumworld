...
public class AbstractEISInterface extends EIDefaultImpl {
	...
	/*
	 * This map contains references to any object that is
	 * registered as an entity with EIS.
	 */
	private Map<String, IEISEntity> entities;
	
	/*
	 * This map contains references to any action that is
	 * registered with EIS. The action identifier is used
	 * to match the action to one of the IEISActions in the
	 * associated list. 
	 */
	...
	protected Percept performEntityAction(String arg0, Action arg1)
		...
		if (action == null) throw new ActException(ActException.NOTSUPPORTEDBYENTITY);

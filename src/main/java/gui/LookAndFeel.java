...
/**
 * Provides a single point of access for layout parameters and colours.
 * Access methods allow parameters to be calculated on-the-fly or randomised if necessary.
 */
...
public class LookAndFeel {
	...
	private static Color deepOrange = new Color(255, 82, 0);
	...
	private static Color[] vacBotColours = {Color.RED, Color.YELLOW, brightBlue, Color.PINK,
		Color.GREEN, Color.ORANGE, Color.GRAY, Color.MAGENTA};
	private static int currentColour = 0;
	private static String[] vacBotNames = {"Henry", "Decco", "Lloyd", "Harry",
		"Keano", "Stevo", "Benjy", "Darth"};
	...
	// General grid parameters
	public static Color getGridBackground() {return gridBackground;}
	public static Color getGridLineColour() {return gridLineColour;}
	public static int getSquareSize() {return squareSize;}
	public static int getGridLineWidth() {return gridLineWidth;}
	...
	public static int getVacBotClearance() {return vacBotClearance;}
	public static Color getEyeColour() {return eyeColour;}
	public static int getEyeRadius() {return eyeRadius;}
	public static int getEyePosition() {return eyePosition;}
	public static int getEyeSpacing() {return eyeSpacing;}
	public static Color getPupilColour() {return pupilColour;}
	public static int getPupilRadius() {return pupilRadius;}
	public static int getPupilOffset() {return pupilOffset;}
	public static Color getNoseColour() {return noseColour;}
	public static int getNoseRadius() {return noseRadius;}
	public static int getNosePosition() {return nosePosition;}
	public static Color getWheelColour() {return wheelColour;}
	public static int getWheelWidth() {return wheelWidth;}
	public static int getWheelRadius() {return wheelRadius;}
	public static int getWheelPosition() {return wheelPosition;}
	public static Color getLightOffColour() {return lightOffColour;}
	public static Color getLightOnColour() {return lightOnColour;}
	public static int getLightRadius() {return lightRadius;}
	
	// Dust parameters - called only once for each piece, then stored, so can be randomised
